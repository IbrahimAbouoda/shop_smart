...
extension TextFormFieldStyleHelper on CustomTextFormField {
  static OutlineInputBorder get outlineGray70001TL8 => OutlineInputBorder(
        borderRadius: BorderRadius.circular(
          getHorizontalSize(
            8.00,
          ),
  ...
  static OutlineInputBorder get fillTeal50 => OutlineInputBorder(
        borderRadius: BorderRadius.circular(
          getHorizontalSize(
            16.00,
          ),
  ...
  static OutlineInputBorder get outlineGray70001TL81 => OutlineInputBorder(
        borderRadius: BorderRadius.circular(
          getHorizontalSize(
            8.00,
          ),
  ...
  static OutlineInputBorder get outlineBluegray600 => OutlineInputBorder(
        borderRadius: BorderRadius.circular(
          getHorizontalSize(
            12.00,
          ),
